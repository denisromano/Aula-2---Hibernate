package fiap.com.helper;



import java.util.List;

import fiap.com.entity.Forum;
import fiap.com.entity.Usuario;
...
public class TesteForum {
	...
	private static void incluirForum() {
		...
		forum.setId(20);
		forum.setAssunto("Avaliac?a?o");
		forum.setDescricao("Avaliac?a?o da disciplina Persiste?ncia");
	...
	private static void listarUsuariosPorForum() {
		ForumHelper helper = new ForumHelper();
		List<Usuario> usuarios = helper.listarUsuarios(20);
